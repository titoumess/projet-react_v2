...
export default function Filter({ events, onFilterChange, filters, categories }) {
    ...
    }, [events]); // Le recalcul n'a lieu que lorsque la liste des événements change.

    // Fonction de gestion du changement de tri (par prix ou date)
    const handleSortChange = (e) => {
        onFilterChange({ sort: e.target.value });
    };

    // Fonction de gestion du changement de l'option "montrer uniquement les événements disponibles"
    const handleShowOnlyAvailableChange = (e) => {
        onFilterChange({ showOnlyAvailable: e.target.checked });
    };

    // Fonction de gestion du changement de la sélection de lieu
    ...
    // Vérifier si des filtres sont actifs (au moins un filtre est appliqué)
    ...
    return (
        <div className="bg-white shadow-md rounded-lg px-6 py-4 mb-6">
            <div className="flex justify-between items-center mb-4">
                ...
                {/* Affichage du bouton de réinitialisation des filtres uniquement si des filtres sont actifs */}
                {areFiltersActive && (
                    <button
                    ...
                    >
                        {/* Icône pour réinitialiser les filtres */}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
                ...
                <div className="flex flex-col">
                    ...
                    >
                        ...
                        {/* Liste des lieux uniques générés précédemment */}
                ...
                {/* Filtre pour ne pas afficher les événements complets */}
                <div className="flex items-center h-10">
                    <label className="inline-flex items-center cursor-pointer">
                        ...
                        />
                        {/* Apparence du switch pour afficher/masquer les événements complets */}
